...
public class HpaContainer extends BasicContainer{

    public HpaContainer(EntityPlayer player, IInventory inv, TileEntityHPA entity) {
        super(inv, entity, 4);

        this.addSlotToContainer(new Slot(entity, 0, 27, 33));
        this.addSlotToContainer(new Slot(entity, 1, 47, 33));
        this.addSlotToContainer(new SlotFurnaceOutput(player, entity, 2, 107, 33));
