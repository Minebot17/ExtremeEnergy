...
import gloomyfolken_extreme_energy.hooklib.asm.HookInjectorFactory.MethodEnter;
import gloomyfolken_extreme_energy.hooklib.asm.HookInjectorFactory.MethodExit;
...
public class AsmHook implements Cloneable, Comparable<AsmHook> {
    ...
    public class Builder extends AsmHook {
         ...
         * import static gloomyfolken_extreme_energy.hooklib.asm.TypeHelper.*
         * //...
